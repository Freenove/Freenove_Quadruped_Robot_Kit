/*
 * Sketch     Sketch for control Freenove Quadruped Robot
 * Brief      This sketch is used to control Freenove Quadruped Robot through Serial or Wi-Fi.
...
int xMoveLast, yMoveLast, zMoveLast, xRotateLast, yRotateLast, zRotateLast;
